...
export default function LitterForm({ onSuccess }: LitterFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex justify-end">
        <Button type="submit" disabled={createLitter.isPending}>
          {createLitter.isPending ? "Enregistrement..." : "Créer la portée"}
        </Button>
      </div>
    </form>
  );
